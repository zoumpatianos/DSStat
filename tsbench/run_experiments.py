...
if __name__ == "__main__":
    ...
    elif dataset_type == "BINAR":
        dataset_parser = BinaryParser(filename=dataset_filename[6:], ts_size=ts_length)
    ...
    elif queryset_type == "BINAR":
        query_parser = BinaryParser(filename=queryset_filename[6:], ts_size=ts_length)
    ...
    experiment.load_queries(query_parser, queries_size, progress_update=progress_f)
